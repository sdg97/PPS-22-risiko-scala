...
import view.GuiProgramOne.button3

import java.awt.event.{ActionEvent, ActionListener, MouseEvent, MouseListener}
import java.awt.geom.{Ellipse2D, Point2D}
import java.awt.{Color, Dimension, Font, Graphics2D, Image, *}
import javax.swing.*
import scala.swing.*

object GuiProgramOne extends App {
  // Carica l'immagine di sfondo
  val backgroundImage: Image = javax.imageio.ImageIO.read(new java.io.File("./img/map_grey.jpg"))

  // Crea il frame principale
  val frame = new JFrame("GUI con sfondo")
